...
def evaluate_features(feature_select):
    ...
    for i in posSentences:
        ...
        for var2 in stopwords:
            i=i.replace(' '+var2.strip()+' ','   ')
        stopwords.seek(0)
        if(i2!=i):
            print(i)
    ...
    stopwords2 = open(os.path.join(__location__, 'stopwords.txt'), 'r', encoding='utf8')    
    for i in negSentences:
        i2=i
        for var3 in stopwords2:
            i=i.replace(' '+var3.strip()+' ','   ')
        stopwords2.seek(0)
        var3=''
